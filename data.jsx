  ...
  return (
    <div className="screen-pad fade-in">
      <div className="kpi-grid">
        ...
        <KpiCard icon="handshake" label="Em Negociação" value={k.negociacao} delta="+8%" deltaUp accent={COLORS.cyan} />
        <KpiCard icon="calendar-check" label="Fechamentos no Mês" value={k.fechados} delta="-2%" deltaUp={false} accent={COLORS.green} />
        <KpiCard icon="target" label="Taxa de Conversão" value={k.conversao} suffix="%" delta="+5%" deltaUp accent={COLORS.lime} />
      </div>
